...
-- Estado confirmado de cada monitor, para um reinício não zerar a
...
-- No máximo um incidente aberto por monitor: dois ao mesmo tempo
-- tornariam a duração da queda indefinida.
