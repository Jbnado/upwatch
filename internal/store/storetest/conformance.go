...
func RunConformance(t *testing.T, newStore Factory) {
	...
	cases = append(cases, []conformanceCase{
		{"UserRoleRoundTrips", testUserRoleRoundTrips},
		{"UserListBringsEveryone", testUserListBringsEveryone},
		{"UserDeleteRemovesSessions", testUserDeleteRemovesSessions},
		{"UserCountByRoleSeparates", testUserCountByRoleSeparates},
	}...)
	cases = append(cases, statusPageCases()...)
...
func monitoringCases() []conformanceCase {
	return []conformanceCase{
		...
		{"LatestHeartbeatsOnEmptyStore", testLatestHeartbeatsOnEmptyStore},
		{"LatestHeartbeatsPicksTheNewest", testLatestHeartbeatsPicksTheNewest},
		{"LatestHeartbeatsCoverEveryMonitor", testLatestHeartbeatsCoverEveryMonitor},
